          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {SERVICES.map((service) => {
              ...
              return (
                <div
                  key={service.id}
                  className="reveal group relative rounded-2xl bg-surface border border-border p-8 transition-all hover:shadow-lg hover:border-secondary/30 hover:-translate-y-1"
                >
